"""Real-time pose estimation and hand tracking using MediaPipe.

This script processes an input video, optionally renders the detections in a
window, and writes the detected landmarks to a CSV file. The CSV uses
normalized landmark coordinates output by MediaPipe, making it portable across
